...
const navigation = {
  social: [
    ...
    // {
    //   name: "Facebook",
    //   href: "https://www.facebook.com/kishlaykumar",
    //   icon: (props) => (
    //     <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    //       <path
    //         fillRule="evenodd"
    ...
    // {
    //   name: "YouTube",
    //   href: "https://youtube.com/@kishlay",
    //   icon: (props) => (
    //     <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    //       <path
    //         fillRule="evenodd"
  ...
  return (
    <footer className="bg-black">
      <div className="flex justify-center flex-col items-center mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        <nav 
          className="w-[70%]  columns-2 flex flex-wrap justify-center gap-[2.5rem]"
          aria-label="Footer"
        >
          {main.map((item, index) => {
            return (
