...
function Banner() {
  return (
    <div
      id="sticky-banner"
      tabindex="-1"
      className=" top-0 left-0 z-50 flex justify-between w-full p-4 border-b border-gray-200 bg-gray-50 opacity-75 dark:bg-gray-700 dark:border-gray-600"
    >
      <div className="flex items-center mx-auto">
        <p className="flex items-center text-lg font-normal text-gray-500 dark:text-gray-400">
          ...
          <span>
            Lets Connect{" "}
            <a
              href="https://www.linkedin.com/in/sadanandgadwal/"
